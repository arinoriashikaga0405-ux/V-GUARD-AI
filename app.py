...
# 1. KONFIGURASI SISTEM (PENTING: Harus di atas)
...
def tampilkan_foto(lebar):
    # MENYESUAIKAN KE NAMA FILE YANG BENAR: erwin.jpg
    if os.path.exists('erwin.jpg'):
        st.image(Image.open('erwin.jpg'), width=lebar)
    else:
        # Ikon cadangan jika erwin.jpg tidak ditemukan agar web tidak crash
...
# ==========================================
    ...
    df = pd.DataFrame({
        "Nama Bisnis": ["Resto BSD Utama", "Retail Tangerang", "Cafe Serpong"],
