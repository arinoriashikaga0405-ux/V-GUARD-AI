...
if 'db_nasabah' not in st.session_state:
    st.session_state.db_nasabah = [
        {"ID": 101, "Waktu": "2026-03-25", "Pelanggan": "Siska", "Bisnis": "Cafe Maju", "Usaha": "F&B", "Paket": "SMART", "Status": "🟢 AKTIF"},
        {"ID": 102, "Waktu": "2026-03-28", "Pelanggan": "Jaya", "Bisnis": "Bengkel Berkah", "Usaha": "Otomotif", "Paket": "BASIC", "Status": "🔴 Menunggu"}
    ]
...
with st.sidebar:
    ...
    menu = st.radio("Menu Navigasi:", ["1. Profil", "2. ROI", "3. Paket", "4. Registrasi", "5. Admin"])
