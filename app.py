...
st.markdown("""
    ...
    .roi-panel {
        ...
        border: 1px solid #34d399; padding: 12px; border-radius: 12px; margin-top: 15px;
    }
...
with st.sidebar:
    ...
    st.markdown(f'<p class="founder-name">Erwin Sinaga</p>', unsafe_allow_html=True)
    ...
    st.text_input("Tanya AI...", placeholder="Cek kebocoran hari ini...")
        ...
        with cols[i]:
            ...
            <div class="product-card">
                ...
                <div class="roi-panel">
                    ...
                    <p style="margin:0; font-size:14px; font-weight:bold;">Save {roi} / bln</p>
                </div>
...
# --- 📂 FOLDER 3: PORTAL KLIEN ---
    ...
    with tab_reg:
        ...
        if st.button("🚀 Kirim Pendaftaran"):
            st.success("Data diterima Admin. ID Lisensi akan dikirim setelah verifikasi.")

    with tab_active:
        if not st.session_state['client_authenticated']:
            st.info("Masukkan ID Lisensi untuk membuka dashboard audit AI.")
...
# --- 📂 FOLDER 4: ADMIN PANEL ---
    ...
    if not st.session_state['auth_vguard']:
        ...
        with st.expander("Klik untuk Proses Audit"):
            ...
            if st.button("🚀 JALANKAN AUDIT"): st.info("Memproses data...")
