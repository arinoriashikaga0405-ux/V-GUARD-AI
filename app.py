...
if st.session_state.page == "Admin":
    if not st.session_state.auth:
        ...
        with tab1: # V-SCAN DENGAN AUTO-CALCULATE
            ...
            if up:
                with st.spinner('V-GUARD AI Menganalisa...'):
                    ...
                    potensi_fraud = len(df) * 500000 # Simulasi Auto-Calculate
        ...
        with tab2: # MONITORING (FIXED NAMEERROR)
            ...
            cb1, cb2 = st.columns(2) # Perbaikan variabel kolom
            with cb1: 
