...
if st.session_state.page == "Home":
    ...
    with c2:
        ...
        **Erwin Sinaga** adalah pemimpin strategis dengan rekam jejak prestisius selama lebih dari **sepuluh tahun sebagai eksekutif senior di industri perbankan nasional**. 
        Melalui **VGUARD AI Systems**, beliau mentransformasi keahlian audit perbankan ke dalam solusi teknologi cerdas untuk mengamankan profit bisnis dari ancaman kebocoran data.

        Filosofi beliau, **"Presisi Tanpa Kompromi"**, memastikan bahwa setiap modul AI yang dikembangkan bekerja dengan akurasi maksimal demi integritas data dan keamanan aset klien. 
        VGUARD dirancang untuk memberikan ketenangan bagi pemilik bisnis, memastikan setiap transaksi terjaga oleh perisai digital yang kokoh dan terpercaya di bawah kepemimpinan strategis beliau.
        """)
    ...
    # PAKET LAYANAN STRATEGIS (KEMBALI KE 4 LAYANAN)
