...
# --- 1. KONFIGURASI ENGINE & SECURITY (100% AMAN) ---
# Mengambil kunci dari Secrets Streamlit agar tidak terlihat di kode publik
try:
    GEMINI_API_KEY = st.secrets["GEMINI_API_KEY"]
    genai.configure(api_key=GEMINI_API_KEY)
except Exception:
    st.error("🚨 API Key tidak ditemukan! Pastikan sudah input di Secrets Streamlit.")
    st.stop()
...
if menu == "Visi & Misi":
   ...
   packages = {
       "V-LITE": ["Mikro / 1 Kasir", "750 rb", "350 rb", "AI Fraud Detector Dasar, Daily WA/Email Summary, Monthly PDF Report"],
   ...
   st.markdown(f"""
    ...
    | **Biaya Aktivasi** | 750 rb | 1.5 Jt | 7,5 Jt | 15 Jt |
