...
# Inisialisasi Database dengan Data Simulasi & Jatuh Tempo
    ...
    st.session_state.db_nasabah = [
        {
            ...
            "Jatuh_Tempo": (today + timedelta(days=5)).strftime("%Y-%m-%d"), # Notifikasi aktif
...
<style>
    ...
    .vcs-box { background: #f0f7ff; padding: 20px; border-radius: 10px; border: 1px solid #1E3A8A; margin-top: 10px; }
...
with st.sidebar:
    ...
    st.write("---")
    menu = st.radio("Navigasi Utama:", ["1. 👤 Profil Founder", "2. 🎯 Visi, Misi & ROI", "3. 📦 Paket Unggulan", "4. 📝 Registrasi & Upload", "5. 🔐 Akses Terbatas"])
    st.write("---")
