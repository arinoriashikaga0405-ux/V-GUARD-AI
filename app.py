...
# Teks Profil Founder (Dipisah agar tidak memicu SyntaxError)
profil_text = (
...
<style>
    ...
    .card { background: white; padding: 20px; border-radius: 10px; box-shadow: 2px 2px 10px rgba(0,0,0,0.1); border-top: 5px solid #1E3A8A; min-height: 150px; }
