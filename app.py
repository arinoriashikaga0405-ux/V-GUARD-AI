...
# --- MENU 2: VISI, MISI & ROI (URUTAN ROI DI BAWAH) ---
    ...
    st.markdown("* **Otomasi**: Sistem audit AI 24/7.\n* **Transparansi**: Laporan akurat tanpa manipulasi.\n* **Akurasi**: Deteksi instan anomali transaksi.")
    st.write("---")
...
# --- MENU 3: PAKET LAYANAN (DIPERBAIKI AGAR TIDAK EROR) ---
elif menu == "3. 📦 Paket Layanan":
    st.header("📦 Paket Proteksi V-Guard AI")
    c1, c2, c3, c4 = st.columns(4)
    with c1:
        st.markdown('<div class="package-box"><h3>BASIC</h3><b>Setup: 2.5jt</b><br>Monthly: 75
