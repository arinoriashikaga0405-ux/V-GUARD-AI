...
if st.session_state.page == "Home":
    ...
    with c_img:
        # Menampilkan icon profil profesional
    ...
    hasil_diselamatkan = omzet * (bocor/100) * 0.95
    st.success(f"Potensi Profit Diselamatkan V-GUARD: Rp {hasil_diselamatkan:,.0f} / bln")
    ...
    with p1:
        ...
        st.link_button("💬 Hubungi Erwin", f"https://wa.me/{wa_num}?text=Halo Pak Erwin, saya tertarik paket V-START")
    with p2:
        ...
        st.link_button("💬 Hubungi Erwin", f"https://wa.me/{wa_num}?text=Halo Pak Erwin, saya tertarik paket V-GROW")
    with p3:
        ...
        st.link_button("💬 Hubungi Erwin", f"https://wa.me/{wa_num}?text=Halo Pak Erwin, saya tertarik paket V-PRIME")
