...
# --- 2. CSS CUSTOM EKSEKimport streamlit as st
import pandas as pd
import numpy as np
from datetime import datetime
...
if st.session_state.page == "Admin":
    ...
    with p3:
        st.markdown('<div class="card-paket"><b>V-PRIME</b><h3 style="color:#1e3a8a">10 JT</h3><hr><p style="text-align:left; font-size:0.9rem;">• Fitur V-GROW<br>• Audit Multi-Cabang<br>• Predictive AI Analytics<br><span class="alarm-tag">🔥 V-Guard Fire Alarm</span></p></div>', unsafe_allow_html=True)
    
    with p4:
        st.markdown('<div class="card-paket"><b>V-CUSTOM</b><h3 style="color:#1e3a8a">NEGO</h3><hr><p style="text-align:left; font-size:0.9rem;">• Solusi Enterprise<br>• Integrasi ERP/SAP<br>• Support Strategis 24/7<br><span class="alarm-tag">🔥 V-Guard Fire Alarm</span></p></div>', unsafe_allow_html=True)
...
# Footer
st.write("---")
st.caption(f"© {datetime.now().year} VGUARD AI Systems | Strategically Built by Erwin")UTIF ---
st.markdown("""
    <style>
    .main { background-color: #f8fafc; }
    .header-box { text-align: center; padding: 20px 0; }
