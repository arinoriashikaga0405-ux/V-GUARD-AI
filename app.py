...
# --- MENU 4: ADMIN DASHBOARD (PASSWORD: admin123) ---
    ...
    if pwd == "admin123":
        ...
        if uploaded:
            ...
            st.markdown(f'<div class="invoice-box">📄 Invoice #VGD-{int(time.time())} Terkirim Otomatis.</div>', unsafe_allow_html=True)
